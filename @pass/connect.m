...
%
% where ONE system can be a pass object.
%
% See also pass, connect
...
typePass = ismember(types,'pass');  
if (sum(typePass) > 1)
    error('Only 1 pass object can be interconnected');
end
...
pdGint = pass(At, Bt, Ct, Dt, pdG.parset, ...
