% -------------------------------------------------------------------------
% Testing interconnections for ppss
%
% -------------------------------------------------------------------------
...
%% 
fprintf('\n------------------------------------------------------------\n')
fprintf('PPSS: Checking interconnections\n\n')
...
pdG1 = ppss(pass(a,b,c,d,pv,'InputName','u1','OutputName','y1'));
G1 = ss(pdG1);
...
pdG2 = ppss(pass(a,b,c,d,pv,'InputName','u2','OutputName','y2'));
G2 = ss(pdG2);
...
bodemag(pdGs1,'r',s1,'kx')
legend('Using LPV tools','Using LTI tools')
title('Parallel interconnection, G5 + pdG1')
...
bodemag(pdGs1,'r',s1,'kx')
legend('Using LPV tools','Using LTI tools')
title('Append interconnection, append(G5,pdG1)')
