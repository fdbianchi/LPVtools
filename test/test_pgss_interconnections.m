% -------------------------------------------------------------------------
% Testing interconnections for pgss
%
% -------------------------------------------------------------------------
...
%% 
fprintf('\n------------------------------------------------------------\n')
fprintf('PGSS: Checking interconnections\n\n')
...
pdG1 = pgss(a,b,c,d,pv,fcn,'InputName','u1','OutputName','y1');
G1 = ss(pdG1);
...
pdG2 = pgss(a,b,c,d,pv,fcn,'InputName','u2','OutputName','y2');
G2 = ss(pdG2);
